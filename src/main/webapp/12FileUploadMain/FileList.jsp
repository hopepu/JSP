...
<body>
	...
	<h2>자료실 게시판 리스트</h2>
	<button type="button" onclick="location.href='FileUploadMain.jsp'" >파일 업로드</button>
	<!-- <a href="FileUploadMain.jsp">파일 업로드</a> -->
	
	<%
		MyfileDAO dao = new MyfileDAO(); // 1,2 단계
		List<MyfileDTO> fileLists = dao.myFileList();  // 3,4 단계
		dao.close(); // 5단계
	%>
