...
<body>
	<!-- request는 client가 값을 요청할 때 처리되는 내장된 메모리 영역
	메서드는 2개가 있는데 get방식, post방식 이 있다.
	get 방식은 url을 통해서 요청하는 방법 : 가볍다, 보안상 좋지 않다.
	post방식은 body를 통해서 요청하는 방법 : 보안상 좋고, 대용량 처리가 가능, 무겁다. -->
	
	<h1> 1. 클라이언트와 서버의 환경정보 읽기 </h1>
	<a href = "./RequestWebInfo.jsp?eng=hello&kor=안녕">get 방식의 url로 요청함.</a>
	<br>
	<hr><!-- 경계썬 -->
	...
	성별 :<!-- radio : 단일선택용 -->
		...
		<input type = "radio" name = "sex" value = "women"/>여자<br>
	관심사항 :<!-- checkbox : 복수선택용 -->
		<input type = "checkbox" name = "favo" value = "eco"/>경제
		<input type = "checkbox" name = "favo" value = "pol"/>정치
		<input type = "checkbox" name = "favo" value = "ent"/>연예<br>
	
	자기소개 :<!-- textarea : 설명창 --><br>
	...
	<hr>
	<h3> 3. HTTP 요청 헤더 정보 읽기 </h3> <!-- 요청자의 정보를 알고 싶을때 사용 -->
